        ...
        <nav class="flex-1 p-4 overflow-y-auto">
            <div class="space-y-1">
                ...
                <a href="{{ route('merchant.orders.index') }}" 
                   class="flex items-center gap-3 px-4 py-3 rounded-xl {{ request()->routeIs('merchant.orders.*') ? 'bg-brand-600 text-white' : 'text-slate-600 hover:bg-slate-50 hover:text-brand-600' }} transition">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5">
                ...
                <a href="{{ route('merchant.customers.index') }}" 
                   class="flex items-center gap-3 px-4 py-3 rounded-xl {{ request()->routeIs('merchant.customers.*') ? 'bg-brand-600 text-white' : 'text-slate-600 hover:bg-slate-50 hover:text-brand-600' }} transition">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5">
                ...
                @if($tenant)
                    <a href="{{ route('storefront.index', $tenant->slug) }}" target="_blank" 
                       class="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-600 hover:bg-slate-50 hover:text-brand-600 transition">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-4 h-4 ml-auto text-slate-400">
                ...
                <a href="{{ route('merchant.settings.index') }}" 
                   class="flex items-center gap-3 px-4 py-3 rounded-xl {{ request()->routeIs('merchant.settings.*') ? 'bg-brand-600 text-white' : 'text-slate-600 hover:bg-slate-50 hover:text-brand-600' }} transition">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5">
