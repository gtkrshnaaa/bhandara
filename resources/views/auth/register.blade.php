...
<head>
    ...
    <title>Create Account - Bhandara</title>
    ...
    <div class="relative z-10 min-h-screen flex items-center justify-center px-4 py-12">
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-3xl font-bold text-slate-900 mb-2">Start your journey</h1>
                <p class="text-slate-500">Create your sovereign merchant account</p>
            </div>
